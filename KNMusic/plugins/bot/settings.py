...
from KNMusic.utils.database import (add_nonadmin_chat, get_aud_bit_name,
                                    get_authuser, get_authuser_names,
                                    get_playmode, get_playtype,
                                    get_vid_bit_name, is_nonadmin_chat,
                                    remove_nonadmin_chat, save_audio_bitrate,
                                    save_video_bitrate, set_playmode,
                                    set_playtype)
from KNMusic.utils.decorators.admins import ActualAdminCB
from KNMusic.utils.decorators.language import language, languageCB
from KNMusic.utils.inline.settings import (audio_quality_markup,
                                           auth_users_markup,
                                           playmode_users_markup,
                                           setting_markup,
                                           video_quality_markup)
from KNMusic.utils.inline.start import private_panel
