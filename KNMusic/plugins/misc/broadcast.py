...
from KNMusic.utils.database import (delete_served_chat, delete_served_user,
        ...
        for num in assistants:
            ...
            async for dialog in client.get_dialogs():
                ...
                try:
                    ...
                    print(e)
                    await delete_served_chat(dialog.chat.id)
