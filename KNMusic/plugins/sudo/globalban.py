...
from KNMusic.utils import get_readable_time
from KNMusic.utils.database import (add_banned_user, get_banned_count,
...
async def gbanuser(client, message: Message, _):
    ...
    aa = await message.reply_text(_["gban_6"].format(mention, number_of_chats))
