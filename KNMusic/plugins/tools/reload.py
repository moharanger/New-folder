...
from KNMusic.utils.database import get_authuser_names, get_cmode
from KNMusic.utils.decorators import ActualAdminCB, AdminActual, language
from KNMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await KN.stop_stream(message.chat.id)
    except:
        pass
