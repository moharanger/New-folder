...
from pytgcalls.types import (JoinedGroupCallParticipant,
                             LeftGroupCallParticipant, MediaStream, Update)
from pytgcalls.types.stream import StreamAudioEnded

import config
from KNMusic import LOGGER, YouTube, app
from KNMusic.misc import db
from KNMusic.utils.database import (add_active_chat, add_active_video_chat,
                                    get_assistant, get_audio_bitrate, get_lang,
